! function (factory) {
    ...
    $sk.fn = $sk.prototype = {}, $sk.fn.extend = $.extend, $sk.fn.extend({
        ...
        setup: function () {
            ...
            if (this.settings.fullscreen) {
                ...
                this.skitter_box.width(width).height(height), this.skitter_box.css({
                    ...
                    left: 0,
                    "z-index": 1e3
                }), this.settings.stop_over = !1, $("body").css({
                    overflown: "hidden"
                })
            }
            ...
            if (this.settings.xml ? $.ajax({
                ...
                self.skitter_box.find(".info_slide_thumb").width(width_info_slide), self.skitter_box.css({
                    height: self.skitter_box.height() + self.skitter_box.find(".info_slide").outerHeight()
                ...
                if (info_slide_thumb.find(".image_number").each(function () {
                        ...
                        var x = e.pageX,
                            y = e.pageY,
                            new_x = 0;
                        x -= x_value, y -= y_value, novo_width = w_info_slide_thumb - width_value, new_x = -novo_width * x / width_value, new_x > 0 && (new_x = 0), new_x < -(w_info_slide_thumb - width_skitter) && (new_x = -(w_info_slide_thumb - width_skitter)), y > height_skitter && info_slide_thumb.css({
                            left: new_x
                        })
        ...
        start: function () {
            var self = this,
                init_pause = !1;
            (this.settings.numbers || this.settings.thumbs) && this.skitter_box.find(".info_slide").fadeIn(500), this.settings.dots && this.skitter_box.find(".info_slide_dots").fadeIn(500), this.settings.label && this.skitter_box.find(".label_skitter").show(), this.settings.navigation && (this.skitter_box.find(".prev_button").fadeIn(500), this.skitter_box.find(".next_button").fadeIn(500)), self.settings.auto_play && self.startTime(), self.windowFocusOut(), self.setLinkAtual(), self.skitter_box.find(".image > a img").attr({
                src: self.getCurrentImage()
            }), img_link = self.skitter_box.find(".image > a"), img_link = self.resizeImage(img_link), img_link.find("img").fadeIn(1500), self.setValueBoxText(), self.showBoxText(), self.settings.auto_play && self.stopOnMouseOver();
        ...
        nextImage: function () {
            ...
            }), this.settings.random_ia = animations_functions), animation_type = this.settings.random_ia[this.settings.image_i];
        ...
        animationBlock: function (options) {
            ...
            for (i = 0; i < total; i++) {
                ...
                box_clone.show().delay(delay_time).animate({
                    top: 0,
                    left: _bleft
                }, time_animate, easing), box_clone.find("img").hide().delay(delay_time + 100).animate({
                    opacity: "show"
        ...
        animationCubeStop: function (options) {
            ...
            this.setActualLevel(), this.setLinkAtual(), this.skitter_box.find(".image_main").attr({
                src: this.getCurrentImage()
            });
            var max_w = self.getMaxW(8),
        ...
        animationCircles: function (options) {
            ...
            for (i = 0; i < total; i++) {
                ...
                }), size_box += 200, this.addBoxClone(box_clone);
                var delay_time = 70 * i,
                    callback = i == total - 1 ? callbackFn : "";
                box_clone.delay(delay_time).animate({
                    top: _ftop,
                    left: _fleft,
                    opacity: "show"
        ...
        animationCirclesInside: function (options) {
            ...
            for (i = 0; i < total; i++) {
                ...
                box_clone = this.getBoxCloneBackground({
                    ...
                    "border-radius": radius + "px"
                }), size_box -= 200, this.addBoxClone(box_clone), box_clone.show();
                var delay_time = 70 * i,
                    callback = i == total - 1 ? function () {
                        self.finishAnimation()
                    } : "";
        ...
        animationSwapBars: function (options) {
            ...
            for (i = 0; i < total; i++) {
                ...
                box_clone.delay(delay_time).animate({
                    left: width_box
                }, time_animate, easing), box_clone_next.delay(delay_time).animate({
                    left: 0
                }, time_animate, easing, callback)
            }
        },
        animationSwapBlocks: function (options) {
            ...
            box_clone1.find("img").animate({
                ...
                top: 0
            }, time_animate, easing_new), box_clone_next2.find("img").animate({
                top: -height_box
        ...
        animationCut: function (options) {
            ...
            box_clone1.animate({
                ...
                left: 0
            }, time_animate, easing_new), box_clone_next2.animate({
                left: 0
            }, time_animate, easing_new, callback)
        },
        finishAnimation: function (options) {
            var self = this;
            this.skitter_box.find(".image_main").show(), this.showBoxText(), this.settings.is_animating = !1, this.skitter_box.find(".image_main").attr({
                src: this.getCurrentImage()
        ...
        focusSkitter: function () {
            ...
            self.skitter_box.append(focus_button), focus_button.animate({
                opacity: .3
            }, self.settings.interval_in_elements), $(document).keypress(function (e) {
            ...
            self.skitter_box.find(".focus_button").click(function () {
                ...
                self.settings.foucs_active = !0, $(this).stop().animate({
                    opacity: 0
                ...
                return self.skitter_box.before('<div id="mark_position"></div>'), $("body").prepend(div), $("body").prepend(self.skitter_box), self.skitter_box.css({
                    ...
                    top: _topFinal,
                    left: _leftFinal
                }, 2e3, "easeOutExpo"), $("#mark_position").width(self.skitter_box.width()).height(self.skitter_box.height()).css({
                    background: "none"
                }).fadeTo(300, .3), !1
        ...
        setControls: function () {
            ...
            self.skitter_box.append(play_pause_button), play_pause_button.animate({
                opacity: .3
            }, self.settings.interval_in_elements), play_pause_button.click(function () {
                return self.settings.is_paused ? (self.settings.is_animating || self.skitter_box.find(".progressbar").is(":visible") ? self.resumeTime() : self.settings.elapsedTime = 0, self.settings.progressbar || self.resumeTime(), self.settings.is_paused = !1, $(this).html("pause"), $(this).fadeTo(100, .5).fadeTo(100, 1), $(this).removeClass("play_button"), self.settings.stop_over || (self.clearTimer(!0), !self.settings.is_animating && self.settings.images_links.length > 1 && (self.timer = setTimeout(function () {
                    ...
                    href: self.settings.link_atual
                })))) : ($(this).html("play"), $(this).fadeTo(100, .5).fadeTo(100, 1), $(this).addClass("play_button"), self.pauseTime(), self.settings.is_paused = !0, self.clearTimer(!0)), !1
            })
        },
        ...
        setDimensions: function () {
            var self = this,
                was_set = !1;
            this.skitter_box.css("width", "100%"), this.skitter_box.find(".image_main").attr({
                src: this.getCurrentImage()
            }).css({
                width: "100%",
                height: "auto"
